...
(function() {
  ...
  MegaPixImage.prototype.render = function(target, options) {
    ...
    if($('#canvasImage').width()/$('#canvasImage').height() == 0.75){
            ...
            $('#canvasImage').css("padding-left", "89px");
            $('#canvasImage').css("position", "relative");
            $('#canvasImage').css("top", "55px");
            $('#canvasImage').css("-webkit-transform", "rotate(-6deg)");

        }else if ($('#canvasImage').width()/$('#canvasImage').height() == 1){
            //alert("2");
            $('#canvasImage').css("opacity", "1");
            $('#canvasImage').css("padding-left", "88px");
            $('#canvasImage').css("position", "relative");
            $('#canvasImage').css("top", "60px");
            $('#canvasImage').css("-webkit-transform", "rotate(-7deg)");

        }else if ($('#canvasImage').width()/$('#canvasImage').height() > 1){
            //alert("3");
            $('#canvasImage').css("opacity", "1");
            $('#canvasImage').css("padding-left", "203tpx");
            $('#canvasImage').css("position", "relative");
            $('#canvasImage').css("top", "165px");
            $('#canvasImage').css("-webkit-transform", "rotate(-97deg)");
            //alert("Please upload portrait image, instead of landscape.");

        }else {
            //alert("4");
            $('#canvasImage').css("opacity", "1");
            $('#canvasImage').css("padding-left", "96px");
            $('#canvasImage').css("position", "relative");
            $('#canvasImage').css("top", "62px");
            $('#canvasImage').css("-webkit-transform", "rotate(-7deg)");
